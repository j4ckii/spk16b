...
{block name=body}
	<div class="jumbotron stundenplan">
    	<strong>10 - 14. Oktober</strong>
        <br />
		<a href="img/stundenplan/stundenplan1.jpg" data-toggle="lightbox" data-gallery="stundenplan">
			<img src="img/stundenplan/stundenplan1.jpg" class="img-thumbnail">
		</a>
        <br />
        <br />
